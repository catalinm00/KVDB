...
func NewInstanceAutoRegisterService(configServer *client.ConfigServerClient,
	instanceManager *domain.DbInstanceManager, config config.Config) *InstanceAutoRegisterService {
